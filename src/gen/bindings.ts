...
export const commands = {
  async addMods(
    ...
    backupName: string,
  ): Promise<Result<LibraryDTO, SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('add_mods', {
          paths,
          unknownModName,
          backupName,
        }),
  ...
  async toggleMod(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('toggle_mod', { id, isActive }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getBackups(modId: string): Promise<Result<ModBackup[], SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_backups', { modId }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getModDocumentation(
    modId: string,
  ): Promise<Result<string | null, SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_mod_documentation', { modId }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<LibrarySwitch, SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('rename_library', { name, libraryId }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async rebuildLibraryCache(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('rebuild_library_cache', { libraryId }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async openLibrary(path: string): Promise<Result<LibrarySwitch, SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('open_library', { path }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async createLibrary(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('create_library', { requirement }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async closeLibrary(repoRoot: string): Promise<Result<LibrarySwitch, SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('close_library', { repoRoot }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async removeLibrary(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('remove_library', { repoRoot }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async createSimulationGameRoot(
    basePath: string | null,
  ): Promise<Result<string, SError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('create_simulation_game_root', { basePath }),
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
...
export type LibraryCreationRequirement = {
  gameRoot: string
...
export type LibraryDTO = {
  ...
  repoRoot: string
  sptVersion: string
  mods: Partial<{ [key in string]: Mod }>
  isDirty: boolean
}
export type LibrarySwitch = {
  active: LibraryDTO | null
